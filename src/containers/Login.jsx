            ...
            <div className="login-content">
                <div className="content-wrapper">
                            ...
                            () => (
                                <Form className="form">
                                    ...
                                    <div className="form-submit">
                                        <Button bold btnBlock type="submit" size="small">Sign in</Button>
                                    </div>
                                </Form>
                            )
                        }
                    ...
                    <div className="auth-footer-btn">
                        <button className="bg-blue" type="button">{facebook}</button>
                        <button className="bg-red" type="button">{twitter}</button>
                        <button className="bg-skyblue" type="button">{mail}</button>
                        <button className="bg-black" type="button">{github}</button>
                    </div>
                </div>
            </div>
        </div>
